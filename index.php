...
if (isset($_SESSION['User_ID'])) {
    ...
    $Username = 'Guest'; // ถ้าไม่ได้ล็อกอินให้แสดง Guest
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="nav-right">
                        ...
                        <div class="profile-dropdown">
                            ...
                            <div class="profile-dropdown-content">
                                <div class="role">
                                <a href="profile.php" class="active">User: <?php echo htmlspecialchars($Username); ?></a>
                                </div>
...
<div id="paymentModal" class="modal" style="display: none;">
    ...
    <div class="modal-page">
        ...
        <div class="btn-control">
            <button onclick="processPayment()" class="btn btn-confirm-payment"> <a href="order.php">Confirm Payment</a></button>
